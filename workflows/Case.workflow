...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <rules>
        <fullName>Assign Community Cases to Tier 1 Queue</fullName>
        <actions>
    ...
    <rules>
        <fullName>Assign Social Cases to Social Queue</fullName>
        <actions>
    ...
    <rules>
        ...
        <description>Reassign case ownership to Tier 2 queue.</description>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    </rules>
    <rules>
        <fullName>First Contact Close</fullName>
        <actions>
            <name>Check_First_Contact_Close_box</name>
            <type>FieldUpdate</type>
        </actions>
        <active>true</active>
        <description>Automatically checks the &quot;First Contact Close&quot; box on the case when the case moves directly from status &quot;New&quot; to status &quot;Closed&quot;.</description>
        <formula>AND( 
NOT(ISNEW()), 
ISCHANGED(Status), 
...
ISPICKVAL(Status, &quot;Closed&quot;) 
    ...
    <rules>
        <fullName>Resolution Proposed</fullName>
        <active>false</active>
        <criteriaItems>
            <field>Case.Status</field>
            <operation>equals</operation>
