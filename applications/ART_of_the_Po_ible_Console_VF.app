...
<CustomApplication xmlns="http://soap.sforce.com/2006/04/metadata">
    <customApplicationComponents>
        ...
        <customApplicationComponent>AgentStats</customApplicationComponent>
        <customApplicationComponent>MyNotes</customApplicationComponent>
        <customApplicationComponent>Shortcuts</customApplicationComponent>
        <customApplicationComponent>URL_Shortener</customApplicationComponent>
    </customApplicationComponents>
    <defaultLandingTab>standard-home</defaultLandingTab>
    <description>Agent Console 2.0 with custom VF pages</description>
    ...
    <keyboardShortcuts>
        <customShortcut>
            <action>Get Next Available Case</action>
            <active>true</active>
            <keyCommand>SHIFT+N</keyCommand>
            <eventName>customShortcut.Next</eventName>
        </customShortcut>
        <customShortcut>
            <action>Logout</action>
            <active>true</active>
            <keyCommand>SHIFT+X</keyCommand>
            <eventName>customShortcut.Logout</eventName>
        </customShortcut>
        <customShortcut>
            <action>Close current Case and open next available</action>
            <active>true</active>
            <keyCommand>SHIFT+C</keyCommand>
            <eventName>customShortcut.CloseAndNext</eventName>
        </customShortcut>
        <defaultShortcut>
    ...
    <label>ART of the Possible Console (VF)</label>
    <listPlacement>
